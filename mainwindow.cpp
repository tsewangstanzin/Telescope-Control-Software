...
void MainWindow::updateInfiniteCount(double ams ,int azd,int azm,int altd,int altm,double asec,double altsec, char signRA,char signDEC,int chour,int cminute,int csecond,int cdeg,int camin,int casec,char signha,char signde,int cehour,int ceminute,int cesecond,int cedeg,int ceamin,int ceasec)
{
...
void MainWindow::startInfiniteCount()
{
    ...
    connect(worker, SIGNAL(updateInfiniteCount(double,int,int,int,int,double,double,char,char,int,int,int,int,int,int,char,char,int,int,int,int,int,int)), this, SLOT(updateInfiniteCount(double,int,int,int,int,double,double,char,char,int,int,int,int,int,int,char,char,int,int,int,int,int,int)));
