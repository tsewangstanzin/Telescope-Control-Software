...
void MainWindow::updateCount(double cnt)
{
    ui.countOut->setText(QString::number(cnt));
}

void MainWindow::updateInfiniteCount(double cnt)
{
...
void MainWindow::startCount()
{
    ...
    connect(worker, SIGNAL(updateCount(double)), this, SLOT(updateCount(double)));
    workerThread->start();
...
void MainWindow::startInfiniteCount()
{
    ...
    connect(worker, SIGNAL(updateCount(double)), this, SLOT(updateInfiniteCount(double)));
