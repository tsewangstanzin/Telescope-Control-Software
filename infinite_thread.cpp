...
void InfiniteCountWorker::doWork()
{
    ...
    while(m_running){
        ...
        emit updateInfiniteCount(ams,azd,azm,altd,altm,asec,altsec,signRA,signDEC,chour,cminute,csecond,cdeg,camin,casec, signha, signde, ihmsfha[0],ihmsfha[1],ihmsfha[2],idmsfdec[0],idmsfdec[1],idmsfdec[2]);
